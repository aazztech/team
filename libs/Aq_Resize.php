...
if(!function_exists('aq_resize')) {
     ...
     * @param $width int Cropping width
     * @param $height int Cropping Height
     * @param $crop   bool HardCrop
     * @param $single bool Whether to return single image url or image url with with height and width
     * @param $upscale bool
